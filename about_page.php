...
<body>
    <section class="sub-header">
        ...
        <div class="row">
            <div class="about-col">
            <h1>About us</h1>
            <p>Our school is a vibrant and inclusive learning community that fosters a nurturing environment for students to thrive academically, socially, and emotionally.Situated in a picturesque location, our campus provides a conducive setting for education</p>
            </div>
            <div class="about-col">
...
Our campus offers a diverse range of activities to cater to different interests and passions.<br> Students can participate in clubs and organizations focused on various hobbies, sports, arts, and social causes. </p>
    ...
    <script>
        ...
        ScrollReveal().reveal('.row .course-col, .row .campus-col, .activities-col img, .course p, .campus p, .activities p, .text-box p, .text-box a', { delay: 600, origin: 'bottom'});
    </script>
